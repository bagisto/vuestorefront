...
export default {
  ...
  setup(props, context) {
    ...
    const companyDetails = ref({
      ...
      street: 'H-28, 2nd floor, ARV Park,',
      city: 'Sector 63, Noida, Uttar Pradesh 201301 (India)',
      email: 'sales@bagisto.com'
    });

    const orderNumber = ref(query?.orderId ? `#${query?.orderId}` : '80932031-030-00');
